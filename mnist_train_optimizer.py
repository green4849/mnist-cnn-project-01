...
#%%
def train(model, train_loader, val_loader, criterion, optimizer, scheduler, epochs: int=10, device=None, save_dir: str = None):
    model.train()
...
def main(args):
    ...
    train_loader = DataLoader(train_ds,  batch_size=args.batch_size,   shuffle=not args.no_shuffle, num_workers=4)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_name", type=str,   default="cnn_gap", help="base name for the output directory")
